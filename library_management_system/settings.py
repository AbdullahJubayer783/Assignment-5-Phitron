...
# SECRET_KEY = 'django-insecure-()yn7%ers5r=*h7(4g1g9uz(d41mreyb%0^_pqr+3dwr5iluu6'
...
CSRF_TRUSTED_ORIGINS = ['https://mamar-library-55nl.onrender.com','https://*.127.0.0.1']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # 'borrow_book.processors.balance',
            ],
        },
    },
]
